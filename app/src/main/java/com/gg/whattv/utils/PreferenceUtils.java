...
public class PreferenceUtils {
    ...
    public static boolean contains(Context context, String key) {
        return PreferenceUtils.getSharedPreferences(context).contains(key);
    }

    public static int getInt(final Context context, final String key, final int defaultValue) {
        return PreferenceUtils.getSharedPreferences(context).getInt(key, defaultValue);
    }

    public static boolean putInt(final Context context, final String key, final int pValue) {
        final SharedPreferences.Editor editor = PreferenceUtils.getSharedPreferences(context).edit();
    ...
    public static long getLong(final Context context, final String key, final long defaultValue) {
        return PreferenceUtils.getSharedPreferences(context).getLong(key, defaultValue);
    }

    public static Long getLong(final Context context, final String key, final Long defaultValue) {
        if (PreferenceUtils.getSharedPreferences(context).contains(key)) {
            return PreferenceUtils.getSharedPreferences(context).getLong(key, 0);
        } else {
            return null;
        }
    }
    ...
    public static boolean getBoolean(final Context context, final String key, final boolean defaultValue) {
        return PreferenceUtils.getSharedPreferences(context).getBoolean(key, defaultValue);
    }
    ...
    public static String getString(final Context context, final String key, final String defaultValue) {
        return PreferenceUtils.getSharedPreferences(context).getString(key, defaultValue);
    }
